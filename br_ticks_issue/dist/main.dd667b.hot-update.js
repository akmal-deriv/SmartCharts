...
var Feed = /*#__PURE__*/function () {
  ...
  _createClass(Feed, [{
    ...
    value: function _appendChartData(quotes, key, comparisonChartSymbol) {
      ...
      var current_tick_timestamp = new Date().getTime();

      var _current_tick_timestamp = this._serverTime.getEpoch();

      console.error(_current_tick_timestamp - this._last_tick_timestamp);
      console.error(current_tick_timestamp - this.last_tick_timestamp); // THE ISSUE CAN BE FIXED HERE
      ...
      if (comparisonChartSymbol) {
        ...
        if (_current_tick_timestamp - this._last_tick_timestamp < 60) {
          this._stx.updateChartData(quotes, null, {
        ...
        this._last_tick_timestamp = _current_tick_timestamp;
      }
...
//# sourceMappingURL=main.dd667b.hot-update.js.map