...
var Feed = /*#__PURE__*/function () {
  ...
  _createClass(Feed, [{
    ...
    value: function _appendChartData(quotes, key, comparisonChartSymbol) {
      ...
      console.error(current_tick_timestamp - this.last_tick_timestamp); // if (current_tick_timestamp - this.last_tick_timestamp < 2 * 1000) {
      //     console.warn('RIGHT');
      // }
      // else {
      ...
      if (comparisonChartSymbol) {
        ...
        if (current_tick_timestamp - this.last_tick_timestamp < 2 * 1000) {
          ...
          console.error('BWOKEN'); // this._mainStore.chart.refreshChart();
        }
      }
...
//# sourceMappingURL=main.f51f2a.hot-update.js.map