...
var Feed = /*#__PURE__*/function () {
  ...
  _createClass(Feed, [{
    ...
    value: function () {
      var _fetchInitialData = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(symbol, suggestedStartDate, _suggestedEndDate, params, callback) {
        var _this2 = this;
    ...
    value: function _appendChartData(quotes, key, comparisonChartSymbol) {
      ...
      console.log(this._last_tick_timestamp); // console.log(this.last_tick_timestamp);

      console.log(this._serverTime.getEpoch()); // console.log(new Date().getTime());

      var current_tick_timestamp = this._serverTime.getEpoch(); // console.error(_current_tick_timestamp - this._last_tick_timestamp);


      console.error(current_tick_timestamp - this._last_tick_timestamp); // THE ISSUE CAN BE FIXED HERE
...
//# sourceMappingURL=main.dcd901.hot-update.js.map